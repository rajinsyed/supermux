...
> Це український переклад README проєкту [cmux](https://github.com/manaflow-ai/cmux). Цей репозиторій — **supermux**, форк; усе, що додає форк, описано в [README.md](README.md) (англійською).
