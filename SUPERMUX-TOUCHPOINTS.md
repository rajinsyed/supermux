...
- **`cmux.xcodeproj/project.pbxproj` (#95, unfenced):** `SupermuxMobileCore` local package
  ...
  files in the cmux target, `cmuxTests/SupermuxMobileAuthorizationTests.swift` and
  `cmuxTests/SupermuxMobileObserversTests.swift` in the cmuxTests
