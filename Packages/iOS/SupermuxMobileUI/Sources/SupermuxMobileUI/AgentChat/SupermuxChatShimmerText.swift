...
///
/// Used for the "working" state instead of a spinner: a spinner says *a thing
/// is spinning*, whereas shimmering the sentence says *this sentence is what
/// is in progress*. Honors Reduce Motion by falling back to the plain label.
public struct SupermuxChatShimmerText: View, Equatable {
    ...
    public init(text: String, font: Font = .supermuxChatBody()) {
        self.text = text
        self.font = font
    }
