...
> To jest polskie tłumaczenie README projektu [cmux](https://github.com/manaflow-ai/cmux). To repozytorium to **supermux**, fork; to, co fork dodaje, opisano w [README.md](README.md) (po angielsku).
